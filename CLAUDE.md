...
- **The database is never in the way.** A failed read or save is logged and the feed carries on as before the store existed, and a read that hangs is abandoned after the same ten seconds a cold visitor waits.
