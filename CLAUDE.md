...
- **`/bids/direct-purchase` still works** for those older builds: it is a one-item shop order, fee included. They cannot put two items in one shop order, and their bill says delivery is free when it is not; they cannot pay in-app either (§6), so the real amount is what they meet at the pay screen.
