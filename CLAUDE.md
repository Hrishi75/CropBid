...
- **Nothing Razorpay has touched.** A captured deal, a shop payment or a wallet top-up anywhere in the set refuses the whole purge, and the card says so and offers no button. Money against a demo account is a thing to look at, not to tidy away.
