// =============================================================================
// Government Minimum Support Price (MSP) — India
// =============================================================================
// Reference floor prices used to warn farmers and buyers when a price drops
// below the official government support price for a crop.
//
...
//     a separate statutory price, not an MSP.
// All base values are in ₹ per QUINTAL (1 quintal = 100 kg).
//
// MSP only legally covers the ~23 mandated crops. Crops in our catalogue with
// NO central price (Potato, Onion, Tomato, Coffee, Tea, Pepper, Coconut, Banana,
// Turmeric) are intentionally omitted — no floor is enforced for them. Keys
// match the CROPS list in CreateListing. Update annually when rates are revised.
// =============================================================================
