 ...
 * dropped its brand icons, and these need to be exact — a redrawn logo is
 * the kind of thing a brand team notices. All three are the Simple Icons paths.
 * Adding one here means adding it to sameAs in index.html too (see below).
 */
const SOCIALS: Array<{ label: string; href: string; path: string }> = [
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/cropbid/',
