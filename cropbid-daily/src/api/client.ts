// =============================================================================
// API client — axios instance for CropBid Daily
// =============================================================================
// Lifted from mobile/src/api/client.ts, which is the proven version. The only
// deliberate difference is REFRESH_KEY: Daily and CropBid can be installed on
// the same phone, and a shared key would let one app's sign-out revoke the
// other's session.
//
// Adapted for native the same way the business app is:
...
const REFRESH_KEY = 'cropbid.daily.refreshToken';
